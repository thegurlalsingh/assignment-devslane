...
function HomepagePrivate({ addToCart }) {
  const { id } = useParams()
    ...
    <div className="min-h-screen bg-gray-300">
      ...
      <div className="w-full flex justify-between items-center bg-white px-6 py-4 shadow mb-6">
        <img
          ...
          alt="Logo"
        />
        <Link to="assignment_74_1/cart" className="text-blue-600 font-semibold hover:underline">
          See Cart
        </Link>
      </div>
          ...
          <div className="flex flex-wrap flex-row gap-6 justify-evenly">
            {sortedProducts.map((product) => (
              ...
              >
                ...
                {/* Buttons */}
                <Link
                  to={`/assignment_74_1/product/${product.id}`}
